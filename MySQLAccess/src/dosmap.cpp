/*
 * This file is included in CORAL build only for WIN32 platform in order to
 * support /MD (multi-threaded DLL run-time) based builds of LCG software.
 * The code has not been otherwise modified and is taken from VC++ sources
 * as is.
 * All the respective copyrights are held as claimed below
 */
#ifdef WIN32
