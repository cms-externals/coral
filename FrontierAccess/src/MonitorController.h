#ifndef FRONTIER_ACCESS_MONITORCONTROLLER_H
#define FRONTIER_ACCESS_MONITORCONTROLLER_H
...
namespace coral {
  ...
  namespace FrontierAccess {
     ...
     *
     * Implementation of the IMonitoring interface for the FrontierAccess module
     */
