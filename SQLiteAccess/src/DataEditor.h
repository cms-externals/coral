#ifndef SQLITEACCESS_DATAEDITOR_H
#define SQLITEACCESS_DATAEDITOR_H
...
namespace coral {
  ...
  namespace SQLiteAccess {
    ...
    /**
       @class DataEditor DataEditor.h

       Implementation of the ITableDataEditor interface for the SQLiteAccess module
       @author Zhen Xie
    */
