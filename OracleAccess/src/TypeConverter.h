#ifndef ORACLEACCESS_ORACLETYPECONVERTER_H
#define ORACLEACCESS_ORACLETYPECONVERTER_H
...
namespace coral {
  ...
  namespace OracleAccess {
    ...
    /**
       ...
       Implementation of the IRelationalTypeConverter interface for the OracleAccess module
    */
    ...
    public:
       ...
       */
      void setCppTypeForSqlType( const std::string& cppType,
       ...
       * If any of the types specified is not supported the relevant TypeConverterException is thrown.
       */
      void setSqlTypeForCppType( const std::string& sqlType,
