...
coral::PyCoral::IForeignKey_Type()
{
  static PyMethodDef IForeignKey_Methods[] = {
    { (char*) "name", (PyCFunction) IForeignKey_name, METH_NOARGS,
      (char*) "Returns the system name of the foreign key constraint." },
    { (char*) "columnNames", (PyCFunction) IForeignKey_columnNames, METH_NOARGS,
      (char*) "Returns the names of the columns defining the constraint." },
    { (char*) "referencedTableName", (PyCFunction) IForeignKey_referencedTableName, METH_NOARGS,
      (char*) "Returns the name of the referenced table." },
    { (char*) "referencedColumnNames", (PyCFunction) IForeignKey_referencedColumnNames, METH_NOARGS,
