...
coral::PyCoral::IBulkOperation_Type()
{
  static PyMethodDef IBulkOperation_Methods[] = {
    { (char*) "processNextIteration", (PyCFunction)(void *) IBulkOperation_processNextIteration, METH_NOARGS,
      (char*) "Processes the next iteration." },
    { (char*) "flush", (PyCFunction)(void *) IBulkOperation_flush, METH_NOARGS,
