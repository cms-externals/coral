...
static int  Blob_getReadBuffer( PyObject *self, int idx, void **ptrptr );
static int  Blob_getCharBuffer( PyObject *self, int idx, void **ptrptr );
static int Blob_getWriteBuffer( PyObject *self, int idx, void **ptrptr );
static int Blob_getSegCount( PyObject *self, int* lenp );
...
coral::PyCoral::Blob_Type()
{
  static PyMethodDef Blob_Methods[] = {
    { (char*) "size", (PyCFunction) Blob_size, METH_NOARGS,
      (char*) "Returns the size of the BLOB. " },
    { (char*) "extend", (PyCFunction) Blob_extend, METH_O,
      (char*) "Extends the BLOB by additional size in bytes." },
    { (char*) "resize", (PyCFunction) Blob_resize , METH_O,
      (char*) "Resize a BLOB to size in bytes." },
    { (char*) "write", (PyCFunction) Blob_write , METH_VARARGS,
      (char*) "Writes a string or buffer into the BLOB, after extending it accordingly" },
    { (char*) "read", (PyCFunction) Blob_read , METH_O,
      (char*) "Read a string or buffer from the BLOB" },
    { (char*) "readline", (PyCFunction) Blob_readline , METH_NOARGS,
      (char*) "Reads the entire BLOB as one string" },
    { (char*) "append", (PyCFunction) Blob_append , METH_VARARGS,
...
int
Blob_getReadBuffer(PyObject* self, int idx, void** pp)
{
  coral::PyCoral::Blob* py_this = (coral::PyCoral::Blob*) self;
  if (idx != 0 )
  {
...
int
Blob_getWriteBuffer(PyObject* self, int idx, void** pp)
{
...
int
Blob_getCharBuffer(PyObject* self, int idx, void** pp)
{
  return Blob_getReadBuffer(self, idx, pp);
}
...
int
Blob_getSegCount(PyObject* self, int* lenp)
{
  coral::PyCoral::Blob* py_this = (coral::PyCoral::Blob*) self;
