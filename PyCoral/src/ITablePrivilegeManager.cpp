...
coral::PyCoral::ITablePrivilegeManager_Type()
{
  static PyMethodDef ITablePrivilegeManager_Methods[] = {
    { (char*) "grantToUser", (PyCFunction)(void *) ITablePrivilegeManager_grantToUser, METH_VARARGS,
      (char*) "Grants an access right to a specific user." },
    { (char*) "revokeFromUser", (PyCFunction)(void *) ITablePrivilegeManager_revokeFromUser, METH_VARARGS,
      (char*) "Revokes a right from the specified user." },
    { (char*) "grantToPublic", (PyCFunction)(void *) ITablePrivilegeManager_grantToPublic, METH_VARARGS,
      (char*) "Grants the specified right to all users." },
    { (char*) "revokeFromPublic", (PyCFunction)(void *) ITablePrivilegeManager_revokeFromPublic, METH_VARARGS,
