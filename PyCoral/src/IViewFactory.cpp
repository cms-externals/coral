...
coral::PyCoral::IViewFactory_Type()
{
  static PyMethodDef IViewFactory_Methods[] = {
    { (char*) "create", (PyCFunction) IViewFactory_create, METH_O,
      (char*) "Creates a new view with the specified name and the current query definition." },
    { (char*) "createOrReplace", (PyCFunction) IViewFactory_createOrReplace, METH_O,
...
IViewFactory_init( PyObject* self, PyObject* args, PyObject* /*kwds*/ )
{
  ...
  if ( ! PyArg_ParseTuple( args, (char*) "OO",
                           &(py_this->parent),
                           &c_object ) ) return -1;
  py_this->object = static_cast<coral::IViewFactory*>( PyCObject_AsVoidPtr( c_object ) );
...
IViewFactory_create( PyObject* self, PyObject* args)
{
  ...
  try {
    ...
    PyObject* c_object = PyCObject_FromVoidPtr( theCreate,0 );
...
IViewFactory_createOrReplace( PyObject* self, PyObject* args)
{
  ...
  try {
    ...
    PyObject* c_object = PyCObject_FromVoidPtr( theCreateOrReplace,0 );
    PyObject* temp = Py_BuildValue((char*)"OO", py_this, c_object );
    bool ok = ( ob->ob_type->tp_init( (PyObject*) ob,temp,0)==0);
    Py_DECREF(temp);
    Py_DECREF( c_object );
